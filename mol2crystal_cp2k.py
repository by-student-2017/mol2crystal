...
def cp2k_optimize(fname, precursor_energy_per_atom):
    try:
        ...
        subprocess.run(["mpirun", "-np", str(cpu_count), "cp2k.psmp", "-i", "cp2k.inp", "-o", "cp2k.out"], cwd=temp_dir, check=True)
        ...
        for sg in range(1, 231):
            ...
            try:
                ...
                if len(atoms) == len(mol):
                    ...
                    cp2k_optimize(fname, precursor_energy_per_atom=user_precursor_energy_per_atom)
